...
def get_system_prompt_blocks(spot_symbol, deposit, risk_percent, books_context=None):
    ...
    text2 = (
        ...
        "ВАЖНО (ЗАКРЫТИЕ ПЯТНИЦЫ И ВЫХОДНЫЕ): Если свечи относятся к вечеру пятницы (после 18:00 UTC+3 / 15:00 UTC) или анализ проводится в выходные по котировкам пятницы, помни, что падение объема (rel_volume < 0.5) обусловлено сворачиванием торгов и закрытием позиций перед выходными. Категорически ЗАПРЕЩАЕТСЯ трактовать вечерний спад объема как паттерны VSA 'No Selling Pressure' / 'No Demand' или строить на нем сценарии накопления. В анализе вечерней пятничной сессии всегда указывай, что снижение активности связано с концом торговой недели, и выдавай direction: \"none\".\n\n"
        "ВАЖНО (СЕССИОННЫЙ РИТМ ЛИКВИДНОСТИ): В каждой свече передается поле 'session' (Asia/London/Overlap/NY). Учитывай суточный цикл рынка:\n"
        "- Ночью в Азии (02:00–10:00 UTC+3) и поздно вечером в США (после 22:00 UTC+3) падение объема — это ЕСТЕСТВЕННЫЙ сон рынка и уход трейдеров спать, а НЕ VSA-сигналы No Supply/No Demand или потеря инициативы.\n"
        "- В 10:00 UTC+3 (открытие Лондона) и 15:00 UTC+3 (открытие США) рост объема — это естественный приход ликвидности сессии.\n"
        "- Различай техническую потерю инициативы и естественные плановые спады объемов (обед в Лондоне 14:00–15:00 UTC+3, обед в NY).\n\n"
